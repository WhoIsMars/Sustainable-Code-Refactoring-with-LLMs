export default class ComplexNumber {
  ...
  public add(that: ComplexNumber): ComplexNumber {
    return new ComplexNumber(this.realValue + that.realValue, this.imagValue + that.imagValue);
  }
  ...
  public mul(that: ComplexNumber): ComplexNumber {
    ...
    return new ComplexNumber(real1 * real2 - imag1 * imag2, imag1 * real2 + real1 * imag2);
  }
