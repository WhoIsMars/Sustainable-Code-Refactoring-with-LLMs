var PhoneNumber = function(phoneNumber) {
    ...
    this.areaCodeString = cleanedNumber.slice(0, 3);
    this.firstPartString = cleanedNumber.slice(3, 6);
    this.secondPartString = cleanedNumber.slice(6, 10);
};
...
PhoneNumber.prototype.toString = function() {
    return `(${this.areaCodeString}) ${this.firstPartString}-${this.secondPartString}`;
};
