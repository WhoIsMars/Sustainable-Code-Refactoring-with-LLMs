...
Robot.prototype.turnRight = function() {
  this._directionIndex = (this._directionIndex + 1) & 3;
  this.bearing = directions[this._directionIndex];
};

Robot.prototype.turnLeft = function() {
  this._directionIndex = (this._directionIndex + 3) & 3;
  this.bearing = directions[this._directionIndex];
};
...
Robot.prototype.advance = function() {
  const vector = vectors[this._directionIndex];
