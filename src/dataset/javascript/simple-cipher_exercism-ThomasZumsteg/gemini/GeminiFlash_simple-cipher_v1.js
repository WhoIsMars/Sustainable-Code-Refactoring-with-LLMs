...
Cipher.prototype.encode = function(plainText) {
    ...
    for (let i = 0; i < plainText.length; i++) {
        ...
        let encodedCharCode = plainCharCode + keyCharCode - 2 * a_ascii;
        encodedCharCode %= alphabet_length;
        encodedCharCode += a_ascii;
...
Cipher.prototype.decode = function(cipherText) {
    ...
    for (let i = 0; i < cipherText.length; i++) {
        ...
        let decodedCharCode = cipherCharCode - keyCharCode;
        decodedCharCode %= alphabet_length;
        decodedCharCode += a_ascii;
