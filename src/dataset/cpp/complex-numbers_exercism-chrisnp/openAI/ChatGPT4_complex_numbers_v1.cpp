...
Complex operator*(const Complex& x, const Complex& y) {
  return Complex(x._real * y._real - x._imag * y._imag, x._imag * y._real + x._real * y._imag);
}
Complex operator/(const Complex& x, const Complex& y) {
  double d = y._real * y._real + y._imag * y._imag;
  return Complex((x._real * y._real + x._imag * y._imag) / d, (x._imag * y._real - x._real * y._imag) / d);
}
} // namespace complex_numbers