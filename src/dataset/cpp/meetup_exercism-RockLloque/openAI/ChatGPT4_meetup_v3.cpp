...
namespace meetup {
    ...
    boost::gregorian::date scheduler::second_monday() const { return nth_day(boost::date_time::weekdays::Monday, 2); }
    boost::gregorian::date scheduler::second_tuesday() const { return nth_day(boost::date_time::weekdays::Tuesday, 2); }
    boost::gregorian::date scheduler::second_wednesday() const { return nth_day(boost::date_time::weekdays::Wednesday, 2); }
    boost::gregorian::date scheduler::second_thursday() const { return nth_day(boost::date_time::weekdays::Thursday, 2); }
    boost::gregorian::date scheduler::second_friday() const { return nth_day(boost::date_time::weekdays::Friday, 2); }
    boost::gregorian::date scheduler::second_saturday() const { return nth_day(boost::date_time::weekdays::Saturday, 2); }
    boost::gregorian::date scheduler::second_sunday() const { return nth_day(boost::date_time::weekdays::Sunday, 2); }

    boost::gregorian::date scheduler::third_monday() const { return nth_day(boost::date_time::weekdays::Monday, 3); }
    boost::gregorian::date scheduler::third_tuesday() const { return nth_day(boost::date_time::weekdays::Tuesday, 3); }
    boost::gregorian::date scheduler::third_wednesday() const { return nth_day(boost::date_time::weekdays::Wednesday, 3); }
    boost::gregorian::date scheduler::third_thursday() const { return nth_day(boost::date_time::weekdays::Thursday, 3); }
    boost::gregorian::date scheduler::third_friday() const { return nth_day(boost::date_time::weekdays::Friday, 3); }
    boost::gregorian::date scheduler::third_saturday() const { return nth_day(boost::date_time::weekdays::Saturday, 3); }
    boost::gregorian::date scheduler::third_sunday() const { return nth_day(boost::date_time::weekdays::Sunday, 3); }

    boost::gregorian::date scheduler::fourth_monday() const { return nth_day(boost::date_time::weekdays::Monday, 4); }
    boost::gregorian::date scheduler::fourth_tuesday() const { return nth_day(boost::date_time::weekdays::Tuesday, 4); }
    boost::gregorian::date scheduler::fourth_wednesday() const { return nth_day(boost::date_time::weekdays::Wednesday, 4); }
    boost::gregorian::date scheduler::fourth_thursday() const { return nth_day(boost::date_time::weekdays::Thursday, 4); }
    boost::gregorian::date scheduler::fourth_friday() const { return nth_day(boost::date_time::weekdays::Friday, 4); }
    boost::gregorian::date scheduler::fourth_saturday() const { return nth_day(boost::date_time::weekdays::Saturday, 4); }
    boost::gregorian::date scheduler::fourth_sunday() const { return nth_day(boost::date_time::weekdays::Sunday, 4); }
