...
boost::gregorian::date scheduler::teenth_day(boost::date_time::weekdays const& d) const {
  return boost::gregorian::first_day_of_the_week_after(d).get_date(
      {year_, month_, 12});
}
...
boost::gregorian::date scheduler::first_day(
    boost::date_time::weekdays const& d, int nth) const {
  return boost::gregorian::nth_day_of_the_week_in_month(
             boost::gregorian::nth_day_of_the_week_in_month::week_num(nth), d,
             month_)
      .get_date(year_);
}

boost::gregorian::date scheduler::first_monday() const {
  return first_day(boost::date_time::weekdays::Monday, 1);
}

boost::gregorian::date scheduler::first_tuesday() const {
  return first_day(boost::date_time::weekdays::Tuesday, 1);
}

boost::gregorian::date scheduler::first_wednesday() const {
  return first_day(boost::date_time::weekdays::Wednesday, 1);
}

boost::gregorian::date scheduler::first_thursday() const {
  return first_day(boost::date_time::weekdays::Thursday, 1);
}

boost::gregorian::date scheduler::first_friday() const {
  return first_day(boost::date_time::weekdays::Friday, 1);
}

boost::gregorian::date scheduler::first_saturday() const {
  return first_day(boost::date_time::weekdays::Saturday, 1);
}

boost::gregorian::date scheduler::first_sunday() const {
  return first_day(boost::date_time::weekdays::Sunday, 1);
}

boost::gregorian::date scheduler::second_monday() const {
  return first_day(boost::date_time::weekdays::Monday, 2);
}

boost::gregorian::date scheduler::second_tuesday() const {
  return first_day(boost::date_time::weekdays::Tuesday, 2);
}

boost::gregorian::date scheduler::second_wednesday() const {
  return first_day(boost::date_time::weekdays::Wednesday, 2);
}

boost::gregorian::date scheduler::second_thursday() const {
  return first_day(boost::date_time::weekdays::Thursday, 2);
}

boost::gregorian::date scheduler::second_friday() const {
  return first_day(boost::date_time::weekdays::Friday, 2);
}

boost::gregorian::date scheduler::second_saturday() const {
  return first_day(boost::date_time::weekdays::Saturday, 2);
}

boost::gregorian::date scheduler::second_sunday() const {
  return first_day(boost::date_time::weekdays::Sunday, 2);
}

boost::gregorian::date scheduler::third_monday() const {
  return first_day(boost::date_time::weekdays::Monday, 3);
}

boost::gregorian::date scheduler::third_tuesday() const {
  return first_day(boost::date_time::weekdays::Tuesday, 3);
}

boost::gregorian::date scheduler::third_wednesday() const {
  return first_day(boost::date_time::weekdays::Wednesday, 3);
}

boost::gregorian::date scheduler::third_thursday() const {
  return first_day(boost::date_time::weekdays::Thursday, 3);
}

boost::gregorian::date scheduler::third_friday() const {
  return first_day(boost::date_time::weekdays::Friday, 3);
}

boost::gregorian::date scheduler::third_saturday() const {
  return first_day(boost::date_time::weekdays::Saturday, 3);
}

boost::gregorian::date scheduler::third_sunday() const {
  return first_day(boost::date_time::weekdays::Sunday, 3);
}

boost::gregorian::date scheduler::fourth_monday() const {
  return first_day(boost::date_time::weekdays::Monday, 4);
}

boost::gregorian::date scheduler::fourth_tuesday() const {
  return first_day(boost::date_time::weekdays::Tuesday, 4);
}

boost::gregorian::date scheduler::fourth_wednesday() const {
  return first_day(boost::date_time::weekdays::Wednesday, 4);
}

boost::gregorian::date scheduler::fourth_thursday() const {
  return first_day(boost::date_time::weekdays::Thursday, 4);
}

boost::gregorian::date scheduler::fourth_friday() const {
  return first_day(boost::date_time::weekdays::Friday, 4);
}

boost::gregorian::date scheduler::fourth_saturday() const {
  return first_day(boost::date_time::weekdays::Saturday, 4);
}

boost::gregorian::date scheduler::fourth_sunday() const {
  return first_day(boost::date_time::weekdays::Sunday, 4);
}

boost::gregorian::date scheduler::last_day(
    boost::date_time::weekdays const& d) const {
  return boost::gregorian::last_day_of_the_week_in_month(d, month_)
      .get_date(year_);
}
