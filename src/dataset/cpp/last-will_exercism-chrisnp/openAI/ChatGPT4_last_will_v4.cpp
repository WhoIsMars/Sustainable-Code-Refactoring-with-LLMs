namespace zhang {
    ...
    inline int red_code_fragment() { return red_code; }
    inline int blue_code_fragment() { return blue_code; }
}
...
namespace estate_executor {
    ...
    inline int assemble_code() {
        constexpr int total_blues = zhang::blue_code + khan::blue_code + garcia::blue_code;
        constexpr int total_reds = zhang::red_code + khan::red_code + garcia::red_code;
