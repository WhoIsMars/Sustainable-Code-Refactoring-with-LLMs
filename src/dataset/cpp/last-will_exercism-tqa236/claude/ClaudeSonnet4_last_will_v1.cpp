...
namespace estate_executor {
    constexpr int combined_parts = zhang::zhang_part + khan::khan_part + garcia::garcia_part;
    ...
    constexpr int assembled_code = red_code * blue_code;
    
    int assemble_account_number(int secret_modifier) {
        return (combined_parts * secret_modifier) % 10000;
    }
