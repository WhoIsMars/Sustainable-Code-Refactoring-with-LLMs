...
namespace complex_numbers {
    ...
    Complex Complex::operator*(const Complex& rhs) const noexcept {
        return {_real * rhs._real - _imag * rhs._imag, _imag * rhs._real + _real * rhs._imag};
    }
    ...
    Complex Complex::operator/(const Complex& rhs) const noexcept {
        ...
        return {(_real * rhs._real + _imag * rhs._imag) / denom, (_imag * rhs._real - _real * rhs._imag) / denom};
    }
