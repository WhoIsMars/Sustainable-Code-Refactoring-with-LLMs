...
float space_age::space_age::on_mercury() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[MERCURY]);
}

float space_age::space_age::on_venus() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[VENUS]);
}

float space_age::space_age::on_earth() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[EARTH]);
}

float space_age::space_age::on_mars() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[MARS]);
}

float space_age::space_age::on_jupiter() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[JUPITER]);
}

float space_age::space_age::on_saturn() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[SATURN]);
}

float space_age::space_age::on_uranus() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[URANUS]);
}

float space_age::space_age::on_neptune() const noexcept { 
    return static_cast<float>(age / Orbital_Period_Seconds[NEPTUNE]);
}