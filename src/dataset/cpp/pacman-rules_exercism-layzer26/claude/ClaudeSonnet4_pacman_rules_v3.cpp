...
inline bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
...
// dot.
inline bool scored(bool touching_power_pellet, bool touching_dot) {
...
inline bool lost(bool power_pellet_active, bool touching_ghost) {
    return (!power_pellet_active) & touching_ghost;
}
...
inline bool won(bool has_eaten_all_dots, bool power_pellet_active,
         bool touching_ghost) {
    return has_eaten_all_dots & (!power_pellet_active & touching_ghost ? false : true);
}