...
namespace {
    static constexpr std::array<std::pair<const char*, unsigned short>, 8> _allergy_list
    {{ {"eggs", 1}, {"peanuts", 2}, {"shellfish", 4}, {"strawberries", 8}, 
       {"tomatoes", 16}, {"chocolate", 32}, {"pollen", 64}, {"cats", 128} }};
    
    static const std::unordered_map<std::string, unsigned short> _allergy_map = []() {
...
{
    const auto it = _allergy_map.find(aller);
