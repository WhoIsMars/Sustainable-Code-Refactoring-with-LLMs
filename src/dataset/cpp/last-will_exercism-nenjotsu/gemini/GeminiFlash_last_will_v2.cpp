...
namespace estate_executor {
  ...
  int assemble_code() {
    constexpr int red_sum = zhang::red::code_fragment_value + khan::red::code_fragment_value + garcia::red::code_fragment_value;
    constexpr int blue_sum = zhang::blue::code_fragment_value + khan::blue::code_fragment_value + garcia::blue::code_fragment_value;
