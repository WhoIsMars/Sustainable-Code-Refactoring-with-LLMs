...
int years_until_desired_balance(double balance, double target_balance) {
    ...
    while (balance < target_balance && years < 500) { // Add a maximum year limit to prevent infinite loops
    ...
    if (balance < target_balance) {
        return 500; // Or some other error code indicating it didn't converge
    }
