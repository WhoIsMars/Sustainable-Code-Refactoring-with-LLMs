...
template <typename T>
circular_buffer<T>::circular_buffer(size_t capacity) : capacity_(capacity), buffer_(new T[capacity]), head_(0), tail_(0), size_(0) {
    if (capacity == 0) {
...
template <typename T>
circular_buffer<T>::circular_buffer(const circular_buffer& other) : capacity_(other.capacity_), buffer_(new T[other.capacity_]), head_(other.head_), tail_(other.tail_), size_(other.size_) {
