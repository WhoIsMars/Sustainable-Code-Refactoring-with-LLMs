...
namespace space_age {
    ...
    double space_age::on_mercury() const {
        return _age_on_earth / orbital_periods[1];
    }

    double space_age::on_venus() const {
        return _age_on_earth / orbital_periods[2];
    }

    double space_age::on_mars() const {
        return _age_on_earth / orbital_periods[3];
    }

    double space_age::on_jupiter() const {
        return _age_on_earth / orbital_periods[4];
    }

    double space_age::on_saturn() const {
        return _age_on_earth / orbital_periods[5];
    }

    double space_age::on_uranus() const {
        return _age_on_earth / orbital_periods[6];
    }

    double space_age::on_neptune() const {
        return _age_on_earth / orbital_periods[7];
    }
