...
namespace space_age {
    ...
    double space_age::on_mercury() const {
        return _earth_years / orbital_periods[Mercury];
    }

    double space_age::on_venus() const {
        return _earth_years / orbital_periods[Venus];
    }

    double space_age::on_mars() const {
        return _earth_years / orbital_periods[Mars];
    }

    double space_age::on_jupiter() const {
        return _earth_years / orbital_periods[Jupiter];
    }

    double space_age::on_saturn() const {
        return _earth_years / orbital_periods[Saturn];
    }

    double space_age::on_uranus() const {
        return _earth_years / orbital_periods[Uranus];
    }

    double space_age::on_neptune() const {
        return _earth_years / orbital_periods[Neptune];
    }
