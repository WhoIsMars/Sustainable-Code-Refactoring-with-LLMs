...
namespace space_age {
    ...
    space_age::space_age(std::uint64_t earth_age_in_seconds) 
        : _earth_age_in_seconds(earth_age_in_seconds),
          _earth_age_in_years(earth_age_in_seconds * inv_seconds_per_earth_year) {}
    ...
    double space_age::on_mercury() const {
        return _earth_age_in_years * inv_orbital_period_mercury;
    }

    double space_age::on_venus() const {
        return _earth_age_in_years * inv_orbital_period_venus;
    }

    double space_age::on_mars() const {
        return _earth_age_in_years * inv_orbital_period_mars;
    }

    double space_age::on_jupiter() const {
        return _earth_age_in_years * inv_orbital_period_jupiter;
    }

    double space_age::on_saturn() const {
        return _earth_age_in_years * inv_orbital_period_saturn;
    }

    double space_age::on_uranus() const {
        return _earth_age_in_years * inv_orbital_period_uranus;
    }

    double space_age::on_neptune() const {
        return _earth_age_in_years * inv_orbital_period_neptune;
    }
