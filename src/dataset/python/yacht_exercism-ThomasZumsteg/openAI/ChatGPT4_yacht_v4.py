...
LITTLE_STRAIGHT = lambda dice: 30 if straight(dice) and min(dice) == 1 and max(dice) == 5 else 0
BIG_STRAIGHT = lambda dice: 30 if straight(dice) and min(dice) == 2 and max(dice) == 6 else 0
CHOICE = sum
