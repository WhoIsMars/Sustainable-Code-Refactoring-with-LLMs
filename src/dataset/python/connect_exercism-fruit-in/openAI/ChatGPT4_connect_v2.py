    ...
    def is_winner(self, player):
        ...
        while stack:
            ...
            for dr, dc in [(-1, 1), (-1, 0), (0, -1), (0, 1), (1, -1), (1, 0)]:
                nr, nc = r + dr, c + dc
                if 0 <= nr < len(board) and 0 <= nc < len(board[0]) and board[nr][nc] == player and (nr, nc) not in checked:
                    stack.append((nr, nc))
                    checked.add((nr, nc))
