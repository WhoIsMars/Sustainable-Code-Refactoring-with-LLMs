...
class Tree:
    ...
    def __eq__(self, other):
        return self.label == other.label and sorted(self.children, key=lambda x: x.label) == sorted(other.children, key=lambda x: x.label)
    ...
    def path_to(self, from_node, to_node):
        ...
        return [n.label for n in chain(reversed(from_path), to_path[1:])]
