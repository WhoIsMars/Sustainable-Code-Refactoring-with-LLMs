public class SpaceAge {
    ...
    public SpaceAge(Integer seconds) {
        ...
        this.earthAge = this.seconds / EARTH_YEAR_SECONDS;
    }
    ...
    public double onMercury() {
        return this.earthAge / MERCURY_RATIO;
    }

    public double onVenus() {
        return this.earthAge / VENUS_RATIO;
    }

    public double onMars() {
        return this.earthAge / MARS_RATIO;
    }

    public double onJupiter() {
        return this.earthAge / JUPITER_RATIO;
    }

    public double onSaturn() {
        return this.earthAge / SATURN_RATIO;
    }

    public double onUranus() {
        return this.earthAge / URANUS_RATIO;
    }

    public double onNeptune() {
        return this.earthAge / NEPTUNE_RATIO;
    }
}