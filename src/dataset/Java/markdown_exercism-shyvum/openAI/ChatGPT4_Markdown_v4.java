class Markdown {
    ...
    String parse(String markdown) {
        ...
        for (String line : lines) {
            ...
            if (parsedLine == null) parsedLine = parseListItem(line);
            if (parsedLine == null) parsedLine = parseParagraph(line);
    ...
    private String parseHeader(String markdown) {
        int count = 0;
        while (count < markdown.length() && markdown.charAt(count) == '#') count++;
