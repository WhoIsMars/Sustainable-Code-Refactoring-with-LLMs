...
class DifferenceOfSquaresCalculator {
    ...
    public static BigInteger computeSumOfSquaresTo(BigInteger b) {
        return b.multiply(b.add(BigInteger.ONE)).multiply(b.shiftLeft(1).add(BigInteger.ONE)).divide(SIX);
    }
    ...
    public static int computeDifferenceOfSquares(int n) {
        ...
        return (n * (n + 1) * (n - 1) * n) / 12;
    }
    
    public static BigInteger computeDifferenceOfSquares(BigInteger b) {
        return b.multiply(b.add(BigInteger.ONE)).multiply(b.subtract(BigInteger.ONE)).multiply(b).divide(BigInteger.valueOf(12));
    }
