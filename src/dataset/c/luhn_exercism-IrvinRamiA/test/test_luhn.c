...
static void
test_non_numeric_non_space_char_in_middle_with_sum_divisible_by_10_isnt_allowed(void)
{
...
int main(void)
{
   ...
   RUN_TEST(test_valid_string_with_a_non_digit_added_at_the_end_to_become_invalid);
   ...
   RUN_TEST(test_non_numeric_non_space_char_in_middle_with_sum_divisible_by_10_isnt_allowed);
