...
static inline void pour(bucket_id_t from, bucket_id_t to)
{
    ...
    bucket_liters_t pour_amount = bucket_state[from] < available_space ? bucket_state[from] : available_space;
                        ...
                        bucket_liters_t goal_volume, bucket_id_t start_bucket)
{
    ...
    bucket_id_t non_start_bucket = start_bucket ^ 1;
    ...
    result.other_bucket_liters = bucket_state[result.goal_bucket ^ 1];
