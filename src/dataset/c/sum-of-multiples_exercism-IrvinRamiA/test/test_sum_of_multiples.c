...
static void
test_solutions_using_include_exclude_must_extend_to_cardinality_greater_than_3(void)
{
...
int main(void)
{
   ...
   RUN_TEST(test_solutions_using_include_exclude_must_extend_to_cardinality_greater_than_3);
